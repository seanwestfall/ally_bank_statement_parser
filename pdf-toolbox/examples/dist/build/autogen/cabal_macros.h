...
/* package pdf-toolbox-examples-0.1.0 */
#define VERSION_pdf_toolbox_examples "0.1.0"
#define MIN_VERSION_pdf_toolbox_examples(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "pdf-toolbox-examples-0.1.0"

#define CURRENT_PACKAGE_KEY "pdf-toolbox-examples-0.1.0"
